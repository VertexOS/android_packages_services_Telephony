...
public class CallController extends Handler {
    ...
    private CallStatusCode placeCallInternal(Intent intent) {
        ...
        boolean isEmergencyNumber = PhoneUtils.isLocalEmergencyNumber(mApp, number);
        boolean isPotentialEmergencyNumber = PhoneUtils.isPotentialLocalEmergencyNumber(mApp, number);
